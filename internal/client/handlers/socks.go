...
// sshChannelConn wraps an ssh.Channel to implement net.Conn
type sshChannelConn struct {
	ssh.Channel
	laddr, raddr net.Addr
}

func (s *sshChannelConn) LocalAddr() net.Addr  { return s.laddr }
func (s *sshChannelConn) RemoteAddr() net.Addr { return s.raddr }
